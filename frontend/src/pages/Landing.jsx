...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f4] text-[#13241b] flex flex-col justify-between font-sans antialiased selection:bg-[#d97706] selection:text-white">
      ...
      {/* NAVBAR */}
      <header className="max-w-6xl mx-auto w-full px-8 py-10 flex justify-between items-center border-b border-[#dbe4dc] relative z-10">
        ...
        <button 
          ...
          className="flex items-center gap-2.5 bg-[#112c20] hover:bg-[#183e2d] text-white text-sm font-extrabold px-6 py-3 rounded-xl shadow-sm transition-all hover:scale-[1.02] active:scale-95 cursor-pointer border border-[#183e2d]/30"
        >
      ...
      {/* HERO SECTION */}
      <main className="max-w-6xl mx-auto w-full px-8 py-16 md:py-24 flex-1 flex flex-col justify-center space-y-16 relative z-10">
        <div className="space-y-6 text-center">
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-[#091a12] leading-[1.1] max-w-5xl mx-auto">
            Pench Reserve Spatial AI Console
          </h1>
          <p className="text-lg md:text-2xl text-[#4a5d52] max-w-2xl mx-auto font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          {/* WHAT IS THIS? */}
          <div className="bg-white border border-[#dbe4dc] p-10 md:p-12 rounded-3xl shadow-sm space-y-6 hover:shadow-md transition-shadow flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center gap-3.5 text-[#112c20] font-black text-2xl border-b border-[#f4f7f4] pb-4">
